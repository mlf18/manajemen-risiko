...
<body class="hold-transition login-page" style="background:url(<?php echo base_url('assets/images/menpan.jpg')?>); background-position: center; background-repeat: no-repeat;background-size: cover; ">
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Manajemen Risiko </b>| Benturan Kepentingan</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Login Menggunakan Akun Smart Anda</p>
      ...
      <form action="<?php echo base_url()?>/login/do_login" method="post">
        <div class="input-group mb-3">
          <input type="text" name="username" class="form-control" placeholder="Akun Smart">
