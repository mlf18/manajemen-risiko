            ...
            <ul class="nav nav-main">
                ...
                <li class="nav-parent">
                    ...
                    <ul class="nav nav-children">
                        <li><a href="<?php echo base_url();?>index.php/manajemen_risiko/">Siklus Manajemen Risiko</a></li>
                ...
                <li class="nav-parent">
                    ...
                    <ul class="nav nav-children">
                        <li><a href="<?php echo base_url();?>index.php/manajemen_pengawasan/perencanaan_pengawasan">Perencanaan Pengawasan</a></li>
                        <li><a href="<?php echo base_url();?>index.php/manajemen_pengawasan/">Pelaksanaan Pengawasan</a></li>
                        <li><a href="<?php echo base_url();?>index.php/manajemen_pengawasan/">Laporan Pengawasan</a></li>
                        <li><a href="<?php echo base_url();?>index.php/manajemen_pengawasan/">Rekap Pengawasan</a></li>
                        <li><a href="<?php echo base_url();?>index.php/manajemen_pengawasan/">Tindak Lanjut Pengawasan</a></li>
                    </ul>
                </li>
                <li class="nav-parent">
                    <a>
                    ...
                    <ul class="nav nav-children">
                        <li><a href="<?php echo base_url();?>index.php/manajemen_pengawasan/">Daftar Pegawai</a></li>
                        <li><a href="<?php echo base_url();?>index.php/manajemen_pengawasan/">Tambah Pegawai</a></li>
                    </ul>
                </li>
                <li class="nav-parent">
                    <a>
                    ...
                    <ul class="nav nav-children">
                        <li><a href="<?php echo base_url();?>index.php/manajemen_pengawasan/">Daftar Auditee</a></li>
                        <li><a href="<?php echo base_url();?>index.php/manajemen_pengawasan/">Tambah Auditee</a></li>
                    </ul>
                </li>
                <li class="nav-parent">
                    <a>
                ...
                <li class="nav-parent">
                    ...
                    <ul class="nav nav-children">
                        <li><a href="<?php echo base_url();?>index.php/manajemen_pengawasan/">Group</a></li>
