    ...
    <div class="card card-primary card-tabs">
      <div class="card-header p-0 pt-1">
        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="custom-tabs-one-home-tab" href="<?php echo base_url('index.php/sasaran_organisasi/index/') . $id_manajemen_risiko; ?>">Daftar Risiko</a>
          </li>
          <li class="nav-item">
                                                  ...
                                                  ?>
                                                    <tr>
                                                      ...
                                                      <td class="text-center">
                                                        ...
                                                        <a data-toggle="modal" data-target="#rdeleteForm-<?php echo $rvalue->id_risiko; ?>" class="modal-with-form mb-xs mt-xs mr-xs btn btn-danger"><i class="fa fa-trash"></i>&nbsp;</a>
                                                        <div class="modal fade" id="rdeleteForm-<?php echo $rvalue->id_risiko; ?>">
